...
namespace ProcessDashboard.iOS
{
	public class CustomTimeLogCell : UITableViewCell
	{
		...
		UILabel headingLabel, subheadingLabel, thirdheadingLabel;
		...
		public override void LayoutSubviews()
		{
			...
			headingLabel.Frame = new CGRect(10, 10, ContentView.Bounds.Width - 180, 25);
			subheadingLabel.Frame = new CGRect(230, 14, 80, 20);
