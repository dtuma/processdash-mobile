...
namespace ProcessDashboard.iOS
{
    public partial class TaskTimeLogViewController : UIViewController
    {
		...
		public override void ViewDidLoad()
		{
			...
			string[] tableItems = new string[] { "2016-06-02 11:00:02 AM",
				"2016-06-02 2:10:02 PM",
				"2016-06-02 3:30:11 PM",
				"2016-06-03 11:00:02 AM",
				"2016-06-04 1:00:02 AM",
				"2016-06-05 12:00:02 PM",
				"2016-06-06 4:00:02 PM",
				"2016-06-07 11:00:02 PM" };

			TaskTimeLogTable = new UITableView(new CGRect(0, 250, View.Bounds.Width, View.Bounds.Height));
			TaskTimeLogTable.Source = new ProjectsTableSource(tableItems);
